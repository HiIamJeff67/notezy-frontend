...
and it's abandoned due to the new shelf and material structure
Note that the new shelf and material structure does not
using encodedStructure any more, and it also don't require encode and decode algorithm
 */
