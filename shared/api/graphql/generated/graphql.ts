...
export type FragmentedBasicPrivateRoutineTaskFragment = { __typename?: 'PrivateRoutineTask', id: UUID, routineId: UUID, title: string, purpose: RoutineTaskPurpose, costUnit: number, priority: number, status: RoutineTaskStatus, attempts: number, maxAttempts: number, period?: RoutinePeriod | null, nextScheduledAt: Date, scheduledAt: Date, actualStartedAt?: Date | null, actualEndedAt?: Date | null, updatedAt: Date, createdAt: Date } & { ' $fragmentName'?: 'FragmentedBasicPrivateRoutineTaskFragment' };
