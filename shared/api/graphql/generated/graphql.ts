...
export type FragmentedBasicPrivateRoutineTaskFragment = { __typename?: 'PrivateRoutineTask', id: UUID, stationId: UUID, title: string, purpose: RoutineTaskPurpose, costUnit: number, priority: number, status: RoutineTaskStatus, attempts: number, maxAttempts: number, period?: RoutinePeriod | null, nextScheduledAt: Date, scheduledAt: Date, actualStartedAt?: Date | null, actualEndedAt?: Date | null, updatedAt: Date, createdAt: Date, routineIds: Array<UUID> } & { ' $fragmentName'?: 'FragmentedBasicPrivateRoutineTaskFragment' };
...
export type FragmentedPrivateRoutineTaskRecordFragment = { __typename?: 'PrivateRoutineTaskRecord', id: UUID, routineTaskId: UUID, purpose: RoutineTaskPurpose, status: RoutineTaskRecordStatus, errorCode?: RoutineTaskRecordErrorCode | null, errorReason?: string | null, costUnit: number, totalAttempts: number, scheduledAt: Date, actualStartedAt?: Date | null, actualEndedAt?: Date | null, updatedAt: Date, createdAt: Date } & { ' $fragmentName'?: 'FragmentedPrivateRoutineTaskRecordFragment' };
