...
export type FragmentedBasicPublicBadgeFragment = { __typename?: 'PublicBadge', publicId: string, title: string, description: string, type: BadgeType, imageURL?: string | null, createdAt: Date } & { ' $fragmentName'?: 'FragmentedBasicPublicBadgeFragment' };

export type FragmentedBasicPrivateItemFragment = { __typename?: 'PrivateItem', id: UUID, parentSubShelfId: UUID, rootShelfId: UUID, type: ItemType, deletedAt?: Date | null, updatedAt: Date, createdAt: Date } & { ' $fragmentName'?: 'FragmentedBasicPrivateItemFragment' };

export type FragmentedPrivateItemFragment = (
  { __typename?: 'PrivateItem', parentSubShelf: (
    { __typename?: 'PrivateSubShelf' }
...
export type FragmentedBasicPrivateMaterialFragment = { __typename?: 'PrivateMaterial', id: UUID, parentSubShelfId: UUID, name: string, size: number, contentKey: string, contentType: MaterialContentType, parseMediaType: string, deletedAt?: Date | null, updatedAt: Date, createdAt: Date } & { ' $fragmentName'?: 'FragmentedBasicPrivateMaterialFragment' };

export type FragmentedPrivateMaterialFragment = (
  { __typename?: 'PrivateMaterial', parentSubShelf: (
    { __typename?: 'PrivateSubShelf' }
    & { ' $fragmentRefs'?: { 'FragmentedBasicPrivateSubShelfFragment': FragmentedBasicPrivateSubShelfFragment } }
  ) }
...
export type FragmentedBasicPrivateRoutineTaskFragment = { __typename?: 'PrivateRoutineTask', id: UUID, stationId: UUID, title: string, purpose: RoutineTaskPurpose, priority: number, status: RoutineTaskStatus, attempts: number, maxAttempts: number, scheduledAt: Date, actualStartedAt?: Date | null, actualEndedAt?: Date | null, updatedAt: Date, createdAt: Date } & { ' $fragmentName'?: 'FragmentedBasicPrivateRoutineTaskFragment' };
...
export type FragmentedPrivateSubShelfFragment = (
  { __typename?: 'PrivateSubShelf', rootShelf: (
    { __typename?: 'PrivateRootShelf' }
    & { ' $fragmentRefs'?: { 'FragmentedBasicPrivateRootShelfFragment': FragmentedBasicPrivateRootShelfFragment } }
...
export type FragmentedBasicPublicThemeFragment = { __typename?: 'PublicTheme', publicId: string, name: string, isDark: boolean, version: string, isDefault: boolean, downloadURL?: string | null, downloadCount: number, createdAt: Date, updatedAt: Date } & { ' $fragmentName'?: 'FragmentedBasicPublicThemeFragment' };
...
export type FragmentedBasicPublicUserFragment = { __typename?: 'PublicUser', publicId: string, name: string, displayName: string, role: UserRole, plan: UserPlan, status: UserStatus, createdAt: Date } & { ' $fragmentName'?: 'FragmentedBasicPublicUserFragment' };
