...
export type FragmentedBasicPrivateMaterialFragment = { __typename?: 'PrivateMaterial', id: UUID, parentSubShelfId: UUID, name: string, type: MaterialType, size: number, contentKey: string, parseMediaType: string, deletedAt?: Date | null, updatedAt: Date, createdAt: Date } & { ' $fragmentName'?: 'FragmentedBasicPrivateMaterialFragment' };
...
export type FragmentedBasicPrivateRootShelfFragment = { __typename?: 'PrivateRootShelf', id: UUID, name: string, totalShelfNodes: number, totalMaterials: number, lastAnalyzedAt: Date, deletedAt?: Date | null, updatedAt: Date, createdAt: Date } & { ' $fragmentName'?: 'FragmentedBasicPrivateRootShelfFragment' };
