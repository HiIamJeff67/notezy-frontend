...
import { FakePrivateUserInfo } from "@shared/constants";
...
const ProfileTab = memo(() => {
  ...
  const [userInfo, setUserInfo] =
    useState<PrivateUserInfo>(FakePrivateUserInfo);
  ...
  return (
    <Form {...userInfoForm}>
      <form
        onSubmit={async e => {
          e.preventDefault();
          await userInfoForm.handleSubmit(handleSaveUserInfoOnSubmit);
        }}
